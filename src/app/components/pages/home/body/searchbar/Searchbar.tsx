...
const Searchbar: React.FC<SearchbarProps> = (props: SearchbarProps) => {
    return (
        <div className={`flex col-span-3 items-center w-full px-4 py-3 border-b border-gray-400 dark:border-gray-700 space-x-10 overflow-x-hidden`}>
            <input className={inputStyle} placeholder="Search..." onChange={(e) => props.onSearch(e.target.value) }/>
            <div>
            </div>
        </div>
    );
