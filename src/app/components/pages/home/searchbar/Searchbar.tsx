...
const inputStyle = `${background.secondary.get()} ${transition.default} transition-width rounded-xl px-10 py-1 w-52 cursor-pointer
                    hover:outline-none hover:ring-pink-300 hover:ring-2
                    focus:outline-none focus:ring-pink-300 focus:ring-2 focus:w-80`;
