...
import OfferCardContractorName, {
  OfferCardContractorNameProps,
} from "./OfferCardContractorName";
...
export interface OfferCardInfoProps
  extends OfferCardTitleProps,
    OfferCardContractorNameProps,
    OfferCardLocationProps,
    OfferCardDateProps,
    OfferCardSalaryProps,
    OfferCardTagsProps {}

const OfferCardInfo: React.FunctionComponent<OfferCardInfoProps> = (
  props: OfferCardInfoProps
) => (
